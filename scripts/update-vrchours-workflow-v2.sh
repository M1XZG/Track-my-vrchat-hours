#!/bin/bash
# update-vrchours-workflow-v2.sh: Orchestrates fetching Steam playtime and updating README via PR.
#
# Usage:
#   update-vrchours-workflow-v2.sh LOCAL_PATH_TO_REPO STEAM_GAME_ID [cron]
#
# Args:
